...
class SQLHelper {
  static Future<void> createTables(sql.Database database) async {
    ...
    title TEXT, desc TEXT, createdAt TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)
    """);
  }
//  abrir una base de datos SQLite llamada "database_name.db"
...
//insertar datos en una tabla llamada 'data' 
...
//obtiene un solo conjunto de datos de la tabla 'data' en la base de datos SQLite
  static Future<List<Map<String, dynamic>>> getSingleData(int id) async {
    final db = await SQLHelper.db();
    return db.query('data', where:"id = ?", whereArgs:[id], limit:1);
  }

//actualiza los datos en la tabla 'data' de la base de datos SQLite
...
// Elimina fatos de la base de datos
